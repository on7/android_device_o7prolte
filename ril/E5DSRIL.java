...
/**
 * Qualcomm RIL for Samsung Galaxy E5 Variants
 * {@hide}
 */
public class E5DSRIL extends RIL {
    ...
    public E5DSRIL(Context context, int networkMode, int cdmaSubscription) {
        super(context, networkMode, cdmaSubscription, null);
        mQANElements = 6;
    }

    public E5DSRIL(Context context, int preferredNetworkType,
